import { Button, Form, Input, Popconfirm, Table, Tabs, type TabsProps, message } from "antd";
      ...
      render: (_, record) => {
        return (
          <div>
            ...
            {!!record.toUser.headPic && <img src={record.toUser.headPic} width={30} height={30} />}
          </div>
        );
      },
    },
